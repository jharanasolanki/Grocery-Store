    ...
    <div id="payment-box">
        ...
        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr"
            ...
            <input type='hidden' name='business'
                value='sb-jjs645499947@business.example.com'> <input type='hidden'
                ...
                name='notify_url'
                value='https://mygrocerystorephp.herokuapp.com/paypal/notify.php'>
            <input type='hidden' name='cancel_return'
                value='https://mygrocerystorephp.herokuapp.com/paypal/cancel.php'>
            <input type='hidden' name='return'
                value='https://mygrocerystorephp.herokuapp.com/paypal/return.php'>
